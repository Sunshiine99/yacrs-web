...
// Get database connection details from docker environment variable
$DBCFG['host']     = getenv("MYSQL_HOST");
$DBCFG['username'] = getenv("MYSQL_USER");
$DBCFG['password'] = getenv("MYSQL_PASSWORD");
$DBCFG['db_name']  = getenv("MYSQL_DATABASE");
